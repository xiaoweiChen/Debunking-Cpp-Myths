...
\mySubsection{1.2.}{为什么难学}{content/chapter1/2.tex}
...
\mySubsection{2.2.}{加纳的偏远一隅}{content/chapter2/2.tex}
\mySubsection{2.3.}{微软的 C++}{content/chapter2/3.tex}
\mySubsection{2.4.}{自由的编译器}{content/chapter2/4.tex}
\mySubsection{2.5.}{头文件不符合C++规范时}{content/chapter2/5.tex}
...
\mySubsection{4.3.}{打开天窗}{content/chapter4/3.tex}
...
\mySubsection{5.5.}{去序从简}{content/chapter5/5.tex}
...
\mySubsection{7.2.}{并行和并发的定义}{content/chapter7/2.tex}
\mySubsection{7.3.}{并行和并发的常见问题}{content/chapter7/3.tex}
...
\mySubsection{8.1.}{点亮像素}{content/chapter8/1.tex}
