...
def generate_index(book_info):
  header_part = f'''
      <header>
        <h1 style="text-align: center;">{book_info["title"]}</h1>
...
def latex_to_html(latex_content, input_dir, output_dir):
  ...
  generate_index(latex_content['book_info'], output_dir)
  #generate_toc(latex_content['catalogue_info'])
